...
avg=0 #used to count avg messages sent to calculate avg number of words in msgs
leng=0 #used to count avg messages sent to calculate avg number of words in msgs
...
def read_a_message(spy_name): #method to read the encrypted message.
    ...
    if position=="null":
        ...
        if len(secret_text)==0: #HANDLE FOR NO SECRET TEXT IN IMAGE
            ...
            #Boolean= True if message was read.
